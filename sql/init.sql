...
(    
    ...
    POS_GRD_CD      VARCHAR(10)                COMMENT '담당지점(SO) [PHM_POS_GRD_CD]',
    JOB_CD          VARCHAR(10)                COMMENT '발령직무 [PHM_JOB_CD]',
    ...
    HIRE_CD         VARCHAR(10)                COMMENT '[PHM_HIRE_CD]',
    YEARNUM         VARCHAR(2)                 COMMENT '발령호봉 [PHM_HOBONG]',
...
-- 지점코드(담당SO) - POS_GRD_CD 컬럼 사용
(4,  'SO001', '서울지점',   'D001', 'PHM_POS_GRD_CD',   '2020-01-01', '9999-12-31', '1', 1, '2024-01-01'),
(5,  'SO002', '경기지점',   'D001', 'PHM_POS_GRD_CD',   '2020-01-01', '9999-12-31', '2', 1, '2024-01-01'),
(6,  'SO003', '인천지점',   'D001', 'PHM_POS_GRD_CD',   '2020-01-01', '9999-12-31', '3', 1, '2024-01-01'),
(7,  'SO004', '대전지점',   'D001', 'PHM_POS_GRD_CD',   '2020-01-01', '9999-12-31', '4', 1, '2024-01-01'),
(8,  'SO005', '대구지점',   'D001', 'PHM_POS_GRD_CD',   '2020-01-01', '9999-12-31', '5', 1, '2024-01-01'),
(9,  'SO006', '부산지점',   'D001', 'PHM_POS_GRD_CD',   '2020-01-01', '9999-12-31', '6', 1, '2024-01-01'),
-- 직위코드
...
-- 호봉코드 (YEARNUM 컬럼 사용)
(26, '1',  '1호봉',   'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '1',  1, '2024-01-01'),
(27, '2',  '2호봉',   'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '2',  1, '2024-01-01'),
(28, '3',  '3호봉',   'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '3',  1, '2024-01-01'),
(29, '4',  '4호봉',   'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '4',  1, '2024-01-01'),
(30, '5',  '5호봉',   'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '5',  1, '2024-01-01'),
(31, '6',  '6호봉',   'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '6',  1, '2024-01-01'),
(32, '7',  '7호봉',   'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '7',  1, '2024-01-01'),
(33, '8',  '8호봉',   'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '8',  1, '2024-01-01'),
(34, '9',  '9호봉',   'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '9',  1, '2024-01-01'),
(35, '10', '10호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '10', 1, '2024-01-01'),
(36, '11', '11호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '11', 1, '2024-01-01'),
(37, '12', '12호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '12', 1, '2024-01-01'),
(38, '13', '13호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '13', 1, '2024-01-01'),
(39, '14', '14호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '14', 1, '2024-01-01'),
(40, '15', '15호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '15', 1, '2024-01-01'),
(41, '16', '16호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '16', 1, '2024-01-01'),
(42, '17', '17호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '17', 1, '2024-01-01'),
(43, '18', '18호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '18', 1, '2024-01-01'),
(44, '19', '19호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '19', 1, '2024-01-01'),
(45, '20', '20호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '20', 1, '2024-01-01'),
(46, '21', '21호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '21', 1, '2024-01-01'),
(47, '22', '22호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '22', 1, '2024-01-01'),
(48, '23', '23호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '23', 1, '2024-01-01'),
(49, '24', '24호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '24', 1, '2024-01-01'),
(50, '25', '25호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '25', 1, '2024-01-01'),
(51, '26', '26호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '26', 1, '2024-01-01'),
(52, '27', '27호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '27', 1, '2024-01-01'),
(53, '28', '28호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '28', 1, '2024-01-01'),
(54, '29', '29호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '29', 1, '2024-01-01'),
(55, '30', '30호봉',  'D001', 'PHM_HOBONG', '2020-01-01', '9999-12-31', '30', 1, '2024-01-01'),
-- 발령사유코드 (CAU_CD 컬럼 사용)
(56, 'R1', '신규채용',  'D001', 'CAM_CAU_CD', '2020-01-01', '9999-12-31', '1', 1, '2024-01-01'),
(57, 'R2', '승진',      'D001', 'CAM_CAU_CD', '2020-01-01', '9999-12-31', '2', 1, '2024-01-01'),
(58, 'R3', '전보',      'D001', 'CAM_CAU_CD', '2020-01-01', '9999-12-31', '3', 1, '2024-01-01'),
(59, 'R4', '복직',      'D001', 'CAM_CAU_CD', '2020-01-01', '9999-12-31', '4', 1, '2024-01-01'),
-- 직무코드 (JOB_CD 컬럼 사용)
(60, 'J1', '경영관리',  'D001', 'PHM_JOB_CD', '2020-01-01', '9999-12-31', '1', 1, '2024-01-01'),
(61, 'J2', '영업',      'D001', 'PHM_JOB_CD', '2020-01-01', '9999-12-31', '2', 1, '2024-01-01'),
(62, 'J3', '기술',      'D001', 'PHM_JOB_CD', '2020-01-01', '9999-12-31', '3', 1, '2024-01-01'),
(63, 'J4', '연구',      'D001', 'PHM_JOB_CD', '2020-01-01', '9999-12-31', '4', 1, '2024-01-01'),
-- 채용구분코드 (REASON_CD 컬럼 사용)
(64, 'H1', '신입공채',  'D001', 'CAM_REASON_CD', '2020-01-01', '9999-12-31', '1', 1, '2024-01-01'),
(65, 'H2', '경력채용',  'D001', 'CAM_REASON_CD', '2020-01-01', '9999-12-31', '2', 1, '2024-01-01'),
(66, 'H3', '특별채용',  'D001', 'CAM_REASON_CD', '2020-01-01', '9999-12-31', '3', 1, '2024-01-01'),
(67, 'H4', '인턴',      'D001', 'CAM_REASON_CD', '2020-01-01', '9999-12-31', '4', 1, '2024-01-01');


-- ============================================================
-- 기존 DB에서 COLUMN_COMMENT 및 코드 데이터 마이그레이션 (ALTER)
-- 이미 CREATE TABLE이 적용된 DB에서만 실행
-- ============================================================
...
-- PHM_POS_GRD_CD 기존 직급 샘플 데이터를 지점 데이터로 교체 (필요 시)
-- DELETE FROM XFRMD2C WHERE CD_KIND = 'PHM_POS_GRD_CD' AND CD IN ('G1','G2','G3','G4','G5','G6');
-- INSERT INTO XFRMD2C (CD_ID, CD, CD_NM, COMPANY_CD, CD_KIND, STA_YMD, END_YMD, ORD_NO, MOD_USER_ID, MOD_DATE) VALUES
-- (4,'SO001','서울지점','D001','PHM_POS_GRD_CD','2020-01-01','9999-12-31','1',1,'2024-01-01'), ...
